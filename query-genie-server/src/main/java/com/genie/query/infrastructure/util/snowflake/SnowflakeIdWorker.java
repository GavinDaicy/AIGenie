...
public class SnowflakeIdWorker {
    ...
    public List<Long> nextId(int nums) {
    ...
    public static void main(String[] args) {
        SnowflakeIdWorker idGenerate = new SnowflakeIdWorker(3, 40);
        System.out.println( idGenerate.nextId(100));
        System.out.println(idGenerate.nextString());
        idGenerate.nextId();
        idGenerate.nextString();
    }
}
